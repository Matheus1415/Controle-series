...
Route::prefix('series')->group(function () {
    ...
    Route::get('/{serie}/season', [SeasonsController::class, 'index'])->name('seasons.index');
    Route::get('/seasons/{season}/episodes', [EpisodesController::class, 'index'])->name("episodes.index");
    Route::put('/seasons/{season}/episodes', [EpisodesController::class, 'update'])->name("seasons.episodes.update");
});
